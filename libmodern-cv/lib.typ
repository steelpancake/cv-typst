    ...
    align(center)[
      ...
      #block[
        #align(horizon)[
          ...
          #if ("github2" in author) [
            #separator
            #github-icon
            #box[#link("https://github.com/" + author.github2)[#author.github2]]
          ]
...
/// A helper function for resume-entry2() to have location and date in the same line instead
#let resume-entry-helper(primary, secondary, tertiary) = {
  set block(
    above: 0.7em,
    below: 0.7em,
  )
  pad[
    #__justify_align[
      ...
      #grid(
        ...
        align(left)[#tertiary-right-header[#secondary]], secondary-right-header[#tertiary]
      )
    ]
  ]
}
...
#let resume-entry2(
  ...
  block(above: 1em, below: 0.65em)[
    #pad[
      #if date != "" or location != "" [
        #resume-entry-helper(title-content, date, location)
      ]
    ]
  ]
